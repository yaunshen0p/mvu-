/**
 * Workspace utilities for managing code artifacts across multiple tabs.
 * Handles extraction, normalization, and diffing of HTML, CSS, JavaScript, YAML, MVU Script, and Regex artifacts.
 */
...
export const EMPTY_ARTIFACTS: Record<string, string> = Object.freeze(
...
export function normaliseArtifacts(artifacts: Record<string, string> = {}): Record<string, string> {
  const result: Record<string, string> = { ...EMPTY_ARTIFACTS };
...
export function extractArtifactsFromContent(content: string): Record<string, string> {
